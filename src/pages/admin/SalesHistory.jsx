...
const SalesHistory = () => {
  ...
  const load = async (override = {}) => {
    ...
    try {
      ...
      const nextUserId = override.filters?.userId ?? userId;
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="border border-gray-300 rounded-md px-3 py-2 text-sm pl-10 w-full focus:outline-none focus:ring-2 focus:ring-teal"
                  ...
                  {items.map((p) => (
                    <tr key={p.id} className="border-b last:border-0 hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 font-medium text-gray-900">
                        {currencyFormatter.format(p.totalAmount || 0)}
                      </td>
